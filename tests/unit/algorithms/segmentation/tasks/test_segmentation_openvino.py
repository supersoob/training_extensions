...
class TestOpenVINOSegmentationInferencer:
    ...
    def test_predict(self, mocker):
        ...
        mock_post_process = mocker.patch.object(OpenVINOSegmentationInferencer, "post_process", return_value=fake_output)
...
class TestOpenVINOSegmentationTask:
    ...
    def test_infer(self, mocker):
        ...
        mock_predict = mocker.patch.object(OpenVINOSegmentationInferencer, "predict", return_value=(fake_ann_scene, None, fake_input))
    ...
    def test_evaluate(self, mocker):
        ...
        fake_metrics.get_performance.return_value = Performance(score=ScoreMetric(name='fake', value=0.1), dashboard_metrics="mDice")
