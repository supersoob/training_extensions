...
anomaly_paths = [
    os.path.relpath(template.model_template_path) for template in anomaly_templates
]
anomaly_ids = [
    os.path.relpath(template.model_template_id) for template in anomaly_templates
]
